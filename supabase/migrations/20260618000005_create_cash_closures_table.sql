...
DO $$
BEGIN
  IF NOT EXISTS (SELECT FROM pg_tables WHERE schemaname = 'public' AND tablename = 'cash_closures') THEN
    ...
    CREATE INDEX idx_cash_closures_date ON public.cash_closures(closed_at);
